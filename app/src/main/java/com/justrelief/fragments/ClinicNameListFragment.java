...
public class ClinicNameListFragment extends AppBaseFragment implements CustomListAdapterInterface{
    private ListView lv_clinic_list;
    private CustomListAdapter<ClinicNameItem> customListAdapter;
    ...
    public void initViews() {
        ...
        lv_clinic_list = (ListView)findView(R.id.lv_clinic_name);
        customListAdapter = new CustomListAdapter(getActivity(),R.layout.row_clinic_name,itemsList,this);
